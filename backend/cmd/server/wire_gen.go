...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	openClawBillingHandler := handler.NewOpenClawBillingHandler(openClawBillingService)
	...
	openClawBillingLeaseExpiryService := service.ProvideOpenClawBillingLeaseExpiryService(openClawBillingService)
